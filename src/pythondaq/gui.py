...
from pythondaq.diode_experiment import list_devices
import csv
...
class UserInterface(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        for i in list_devices():
            self.ui.select_device.addItem(i)
    ...
    def plot(self):
        ...
        self.start = int(self.ui.Starting.value() * (1023/3.3))
        self.end = int(self.ui.Ending.value() * (1023/3.3))
        self.voltagelist, self.Currentlist, self.powerlist, self.ressistancelist = self.Experiment.scan(self.start,self.end)
        self.ui.plot_widget.plot(x=self.voltagelist, y=self.Currentlist, pen=None, symbol = 'o')
        self.ui.plot_widget.setLabel("left", "'I [A]'")
        self.ui.plot_widget.setLabel("bottom", 'U_zc [V]')
    ...
    def save_button_clicked(self):
        ...
        with open("adruinodata.txt", "w",newline="") as f:
            writer = csv.writer(f)
            writer.writerow(["voltage_zc,Current_resistor"])
